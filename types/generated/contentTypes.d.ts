...
export interface ApiExperienceExperience extends Schema.CollectionType {
  ...
  attributes: {
    ...
    contributions: Attribute.RichText & Attribute.Required;
...
export interface ApiFooterFooter extends Schema.SingleType {
  ...
  attributes: {
    ...
    tag: Attribute.RichText & Attribute.Required;
    subtag: Attribute.RichText & Attribute.Required;
...
export interface ApiLinkLink extends Schema.CollectionType {
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::link.link', 'title'> & Attribute.Required;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiNavNav extends Schema.SingleType {
  ...
  attributes: {
    links: Attribute.Relation<'api::nav.nav', 'oneToMany', 'api::link.link'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
